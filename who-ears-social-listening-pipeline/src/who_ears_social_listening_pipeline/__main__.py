"""who-ears-social-listening-pipeline file for ensuring the package is executable
as `who-ears-social-listening-pipeline` and `python -m who_ears_social_listening_pipeline`
"""
import importlib
